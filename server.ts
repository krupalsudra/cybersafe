...
const LEAKCHECK_API_KEY = Deno.env.get("LEAKCHECK_API_KEY") || "1aa966cec1397b3b48af57b9113cd1a43844e75f";
const GOOGLE_SAFE_BROWSING_KEY = Deno.env.get("GOOGLE_SAFE_BROWSING_KEY") || "AIzaSyDMb0G6Oc-msfdigMLBI76PE_oAb-Mbk0M";
